#!/bin/sh
# Detect Pi model and configure display settings for sparkle-duck-ui.
# Creates /etc/sparkle-duck/display.conf with appropriate environment variables.

CONFIG_DIR="/etc/sparkle-duck"
