...
struct SimRunning {
    ...
    Any onEvent(const DirtSim::Api::NesApuGet::Cwc& cwc, StateMachine& dsm);
    ...
    Any onEvent(const DirtSim::Api::ScenarioSwitch::Cwc& cwc, StateMachine& dsm);
    ...
    Any onEvent(const DirtSim::Api::StatusGet::Cwc& cwc, StateMachine& dsm);
