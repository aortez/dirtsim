    ...
    std::vector<std::string>& updates)
{
    ...
    if (settings.searchSettings.beamWidth < SearchSettings::BeamWidthMin) {
        settings.searchSettings.beamWidth = SearchSettings::BeamWidthMin;
        recordUpdate("searchSettings.beamWidth clamped to minimum");
    }
    else if (settings.searchSettings.beamWidth > SearchSettings::BeamWidthMax) {
        settings.searchSettings.beamWidth = SearchSettings::BeamWidthMax;
        recordUpdate("searchSettings.beamWidth clamped to maximum");
    }
