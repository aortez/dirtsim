...
protected:
     ...
     */
    void setupColumn(const std::vector<Material::EnumType>& materials)
    {
...
protected:
    ...
    void setupMaterialInWater(Material::EnumType material)
    {
 ...
 *
 * DISABLED: Buoyancy physics needs tuning after rigid body refactor.
 */
