...
void EvolutionConfigPanel::createMainView(lv_obj_t* view)
{
    ...
    mutationStagnationWindowStepper_ = LVGLBuilder::actionStepper(rightColumn)
    ...
    mutationRecoveryWindowStepper_ = LVGLBuilder::actionStepper(rightColumn)
...
void EvolutionConfigPanel::updateControlsEnabled()
{
    ...
    setStepperEnabled(mutationPerturbationsStepper_, editingEnabled);
    setStepperEnabled(mutationResetsStepper_, editingEnabled);
    setStepperEnabled(sigmaStepper_, editingEnabled);
    setStepperEnabled(mutationStagnationWindowStepper_, editingEnabled);
    setStepperEnabled(mutationRecoveryWindowStepper_, editingEnabled);
...
void EvolutionConfigPanel::onMutationRecoveryWindowChanged(lv_event_t* e)
{
    EvolutionConfigPanel* self = static_cast<EvolutionConfigPanel*>(lv_event_get_user_data(e));
    ...
    spdlog::debug("EvolutionConfigPanel: Recovery window changed to {}", value);
}
...
void EvolutionConfigPanel::onMutationStagnationWindowChanged(lv_event_t* e)
{
    EvolutionConfigPanel* self = static_cast<EvolutionConfigPanel*>(lv_event_get_user_data(e));
    ...
    spdlog::debug("EvolutionConfigPanel: Stagnation window changed to {}", value);
}
