...
typedef struct SmolnesRuntimeSavestateBlob {
    ...
    ScanlineSprite scanline_sprites[64];
...
static void captureSavestateLocked(SmolnesRuntimeHandle* runtime)
{
    ...
    memcpy(savestate->scanline_sprites, scanline_sprites, sizeof(savestate->scanline_sprites));
    savestate->scanline_sprite_count = scanline_sprite_count;
    ...
    SmolnesRuntimeHandle* runtime, const SmolnesRuntimeSavestateBlob* savestate)
{
    ...
    memcpy(scanline_sprites, savestate->scanline_sprites, sizeof(scanline_sprites));
    scanline_sprite_count = savestate->scanline_sprite_count;
