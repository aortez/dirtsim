...
PhysicsSettings getDefaultPhysicsSettings()
{
    return PhysicsSettings{ .adhesion_strength = 2.0,
                            ...
                            .water_sim_mode = WaterSimMode::MacProjection,
                            .mac_water_buoyancy_strength = 1.0,
                            .mac_water_drag_rate = 10.0,
                            .mac_water_pressure_iterations = 16,
                            .mac_water_velocity_damping_per_second = 0.05,
                            .mac_water_velocity_sleep_epsilon = 0.00005,
