...
TEST_F(LocalShapeProjectionTest, ProjectsSingleCellToGrid)
{
    ...
    projection.project(*world, OrganismId{ 1 }, { 5.5, 5.5 }, { 0.0, 0.0 });
    ...
    EXPECT_EQ(world->getOrganismManager().at({ 5, 5 }), OrganismId{ 1 });
}
...
TEST_F(LocalShapeProjectionTest, ProjectsMultipleCellsToGrid)
{
    ...
    projection.project(*world, OrganismId{ 1 }, { 3.0, 3.0 }, { 0.0, 0.0 });
...
TEST_F(LocalShapeProjectionTest, SetsVelocityOnProjectedCells)
{
    ...
    projection.addCell({ 0, 0 }, MaterialType::WOOD, 1.0);
    projection.project(*world, OrganismId{ 1 }, { 5.0, 5.0 }, { 2.5, -1.0 });
...
TEST_F(LocalShapeProjectionTest, ComputesSubCellCOMFromFractionalPosition)
{
    ...
    projection.project(*world, OrganismId{ 1 }, { 5.75, 5.25 }, { 0.0, 0.0 });
...
TEST_F(LocalShapeProjectionTest, TracksOccupiedCells)
{
    ...
    projection.project(*world, OrganismId{ 1 }, { 5.0, 5.0 }, { 0.0, 0.0 });
...
TEST_F(LocalShapeProjectionTest, ClearsOldProjectionOnReproject)
{
    ...
    // Reproject at (7, 7).
    projection.project(*world, OrganismId{ 1 }, { 7.0, 7.0 }, { 0.0, 0.0 });
