...
We still need to decide whether streamed Debug render should:

- carry `waterVolume` explicitly, or
- remain cell-only while Basic render continues to provide the water overlay.
