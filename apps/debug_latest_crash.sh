...
# This script finds the most recent core dump for the dirtsim executable
# and runs gdb on it to generate a stack trace.

set -eu

# --- Configuration ---
EXECUTABLE_PATH="/home/oldman/workspace/dirtsim/apps/build/bin/dirtsim"
...
# 3. List recent core dumps for dirtsim
echo "===== Recent core dumps for dirtsim ====="
