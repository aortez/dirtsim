#!/bin/bash
# Install Pi configuration files for DirtSim.
...
cp "$SCRIPT_DIR/icons/dirtsim-256.png" ~/.local/share/icons/dirtsim.png
cp "$SCRIPT_DIR/dirtsim.desktop" ~/Desktop/
chmod +x ~/Desktop/dirtsim.desktop
